...
@Entity
@Table(name = "national_identity_documents")
public class NationalIdentityDocumentJpaEntity {
    ...
    @Column(name = "document_number_lookup", length = 64, nullable = false, unique = true, columnDefinition = "CHAR(64)") private String documentNumberLookup;
    ...
    protected NationalIdentityDocumentJpaEntity() { }

    public NationalIdentityDocumentJpaEntity(String id, CitizenId citizenId, String lookup, String payload, String status,
