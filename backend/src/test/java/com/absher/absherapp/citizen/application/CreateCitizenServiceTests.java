...
class CreateCitizenServiceTests {
    ...
    private static final class InMemoryCitizenStore implements CitizenStore {
        ...
        @Override
        public java.util.Optional<Citizen> findById(com.absher.absherapp.citizen.domain.CitizenId citizenId) {
        ...
        public Citizen updateVerifiedPhone(
                com.absher.absherapp.citizen.domain.CitizenId citizenId,
                com.absher.absherapp.citizen.domain.PhoneReference verifiedPhone,
                Instant verifiedAt
        ) {
